...
public class Host_GUI extends JFrame{
    ...
    final public JTextArea output_text = new JTextArea(){{
        setPreferredSize(new DimensionUIResource(scrn_size.width -20, 200));
    }};
    ...
    public void set_test_vals(){
        tb_server_host.setText("127.0.0.1");
        tb_port.setText("1200");
        tb_username.setText("HostA");
        tb_hostname.setText("127.0.0.1");

        tb_command.setText("connect 127.0.0.1 1225");
    }
}